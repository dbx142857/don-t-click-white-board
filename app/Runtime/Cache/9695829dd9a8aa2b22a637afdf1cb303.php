		...
		<div data-role="page" id="page" data-theme="b">
			...
			<div data-role="header" data-theme="c" class="header ui_fixed_hidden">
				...
				<div class="ui-grid-d nav">
					...
					<div class="ui-block-c" tpl_name="fenlei">
						分类
					</div>
			...
			<div data-role="content">
				...
				<div id="content_div_wrapper">
					<div id="div_0" class="content_div">
						...
						<ul data-role="listview" data-inset="true" data-mini="true" class="music_list">
							<li src="app/public/media/test.mp3" class="music_li" data-mini="true">
								<a href="#"><h2>这首歌曲是用来测试的</h2>
									<p>
					...
					<div id="div_1" class="content_div"></div>
					<div id="div_2" class="content_div"></div>
					<div id="div_3" class="content_div"></div>
					<div id="div_4" class="content_div"></div>
				</div>
			</div>
			<div id="list_menu">
			...
			<div data-role="footer" id="footer">
				...
				<div id="range_area">
					<div data-role="rangeslider" data-track-theme="b" data-theme="a" data-mini="true">
						<input type="range" name="range-3a" id="range1" min="0" max="100" value="20">
						<input type="range" name="range-3b" id="range2" min="0" max="100" value="0">
					</div>
				</div>
